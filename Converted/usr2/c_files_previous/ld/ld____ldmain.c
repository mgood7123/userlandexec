...
int
mainld (char *arg, char ** env)
{
  printf("attempting to generate mask argv\n");
// //   char *args="ld_so 0.o 1.o 2.o 3.o 4.o main.o /usr/lib/crt1.o /usr/lib/crti.o /usr/lib/libc.so /usr/lib/crtn.o -o ./b";
//   printf("args: %s\n", args);
  int argc = 0;
...
//       xexit (1);
  ...
  // how can i reliably track mallocs, like if at exit there is a previous malloc that has not been free-d how would i obtain/detect and free it
//   xexit (0);
  return 0;
}
